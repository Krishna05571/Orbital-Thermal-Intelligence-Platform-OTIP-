...
import { RefreshCw, MapPin, Satellite, Flame, Trees, Bell, TrendingUp, Layers, PanelLeftClose, PanelLeft, Radio, FlameKindling, ShieldAlert } from 'lucide-react';
...
export function Navbar({
  ...
  return (
    <header className="h-14 bg-dark-950/95 border-b border-dark-800/80 px-3.5 flex items-center justify-between gap-3 z-30 select-none backdrop-blur-xl shadow-lg transition-colors duration-200">
      ...
      {/* Right Controls: Analytics & Alerts Navigation */}
      <div className="flex items-center gap-2">
